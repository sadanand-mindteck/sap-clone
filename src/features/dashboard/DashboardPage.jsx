        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <StatCard
              ...
              icon={DollarSign}
            />
            <StatCard title="Active Items" value={stats?.activeItemCount} subtext="Products in catalog" icon={Package} />
            <StatCard title="Pending Orders" value={stats?.pendingOrders} subtext="Requires immediate attention" icon={Activity} />
            <StatCard title="Low Stock Alerts" value={stats?.lowStockCount} subtext="Items below reorder point" icon={AlertCircle} />
          </div>
                ...
                <div className="h-[240px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={categoryData} layout="vertical" margin={{ top: 0, right: 30, left: 10, bottom: 5 }}>
                      ...
                      <YAxis dataKey="name" type="category" stroke="#4b5563" fontSize={10} tickLine={false} axisLine={false} width={80} />
                      <Tooltip
